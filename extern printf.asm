...
_start:
    ...
    lea rsi, [rbp-0x40]                     ; loads the array [changed from new arr]
    ...
    ;lea rsi, [rbp-0x20]                    ; [moved up to line 93] loads the new array
    ;sub rsp, 0x8                           ; [moved up to line 94] subs 8 from rsp
    ;lea rdi, [format3]                     ; [moved up to line 95] loads %s from format3
    ;xor rax, rax                           ; [moved up to line 96] sets rax to 0
